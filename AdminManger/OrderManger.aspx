                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <RowStyle HorizontalAlign="Left" />
                          <Columns>
                            ...
                            <asp:BoundField DataField="Ordeuser" HeaderText="订货人" />
                            
                            
                                       <asp:BoundField DataField="OrderStite" HeaderText="订单状态" />
                          
                            <asp:HyperLinkField HeaderText="操作" Text="发货" DataNavigateUrlFields="OrderID"  DataNavigateUrlFormatString="OrderChk.aspx?OrderID={0}">
                                <ControlStyle Font-Underline="False" ForeColor="Black" />
                            </asp:HyperLinkField>
                            <asp:HyperLinkField HeaderText="详细信息" Text="详细信息" DataNavigateUrlFields="OrderID"  DataNavigateUrlFormatString="EditOrder.aspx?OrderID={0}">
                                <ControlStyle Font-Underline="False" ForeColor="Black" />
                            </asp:HyperLinkField>

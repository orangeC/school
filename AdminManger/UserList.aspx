                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                          <asp:BoundField DataField="MemberName" HeaderText="账号" SortExpression="MemberName" />
                                        ...
                                        <asp:BoundField DataField="MemberMoney" HeaderText="会员金额" SortExpression="MemberMoney" />
                                        
                                            
                            <asp:TemplateField HeaderText="充值">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "AddMoney.aspx?id="+Eval("MemberID") %>'
                                        Text="充值"></asp:HyperLink>
                                </ItemTemplate>

...
public partial class AdminManger_SuppliersManger : System.Web.UI.Page
{
    ...
    protected void gvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            mydata.RunSql("delete  from Suppliers  where  id='" + ID + "'");
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string sql = "select  " + strTop + "  * from [Suppliers] ";
    ...
    {
        data.RunSql("insert into Suppliers(SName,STel,SUserName,SDs)values('" + txtname.Text + "','"+TextBox2.Text+"','"+TextBox1.Text+"','"+TextBox3.Text+"')");
        Alert.AlertAndRedirect("添加成功", "SuppliersManger.aspx");

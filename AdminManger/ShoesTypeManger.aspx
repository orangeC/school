<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShoesTypeManger.aspx.cs" Inherits="Admin_ShoesTypeManger" %>
                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyCloseType.aspx?id="+Eval("id") %>'

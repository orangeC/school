...
public partial class Admin_tpnews_updt : System.Web.UI.Page
{
    ...
    {
        sql = "update News set name='" + title.Text.ToString().Trim() + "',content='" + content1.Value + "',typeid='" + DropDownList1.SelectedValue + "',TypeName='" + DropDownList1.SelectedItem.Text + "' where id=" + dID;
        data.RunSql(sql);

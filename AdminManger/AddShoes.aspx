<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddShoes.aspx.cs" EnableEventValidation="false" ValidateRequest="false"  Inherits="AdminManger_AddShoes" %>
  ...
  <td align="center" style="height: 22px">
      添加图书信息</td>
        ...
        <table align="center" bgcolor="#e3ebfe" border="0" cellpadding="2" cellspacing="1"
            ...
            <tr bgcolor="#e7e7e7">
                <td colspan="10" height="24">
                    供应商：<asp:DropDownList ID="DropDownList3" runat="server" Width="155px">
                    </asp:DropDownList></td>
            </tr>
            <tr bgcolor="#e7e7e7">
                <td colspan="10" height="24">
